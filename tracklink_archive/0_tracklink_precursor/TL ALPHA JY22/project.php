        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 w-400 mw-full fade-controller">
                                <div class="card m-0 mb-10 p-0">
                                    ...
                                    <a href="#project-art">
                                        <img src="/data/1234/art-1000-comp.jpg" class="img-fluid rounded-top" style=""
                                             alt="art" draggable="false">
                                    </a>

                                    <div class="content m-0 p-0 pl-10 pr-10 pb-5 mt-5 row">
                                        <div class="col-auto">
                                            <p class="font-size-10 text-muted m-0 p-0">uploaded by dan 2d ago</p>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <a href="#" class="btn-link">
                                                <span class="material-icons font-size-12 fade-target">edit</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="content p-0 pl-15 m-0">
                                    ...
                                    <div class="fade-controller">
                                        <h2 class="font-size-20 m-0 mb-5 p-0 font-weight-bold d-inline">song title</h2>
                                        <a href="#" class="btn-link">
                                            <span class="material-icons font-size-12 fade-target">edit</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="font-weight-light m-0 mb-15 p-0 fade-controller">
                                        <span class="m-0 p-0 font-size-12 text-muted">in</span>
                                        <a href="collection.php?id=1" class="badge">collection name</a>
                                        <a href="#" class="btn-link">
                                            <span class="material-icons align-middle font-size-12 fade-target">add</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="font-weight-light m-0 p-0 mb-15">
                                        ...
                                        <a href="#" class="badge">spaceman_69Xx</a>
                                    </div>

                                    <a href="#" class="btn btn-sm btn-primary mb-10 disabled" role="button">
                    ...
                    <div class="card pt-20">
                        ...
                        <div class="content p-0 m-0 mt-15 audio-player-container">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="progress m-0" style="height: 29px">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    $board->addActivity(new Activity('bem', 'posted a message', time(), ''));
                    $board->addActivity(new Activity('a', 'posted a message', time() - 100, ''));
                    $board->addActivity(new Activity('n', 'posted a message', time() - 1000, ''));
                    $board->addActivity(new Activity('c', 'posted a message', time() - 10000, ''));
                    $board->addActivity(new Activity('sfd', 'posted a message', time() - 100000, ''));
                    $board->addActivity(new Activity('sfd', 'posted a message', time() - 1000000, ''));
                    $board->addActivity(new Activity('sfd', 'posted a message', time() - 10000000, ''));
                    $board->addActivity(new Activity('sfd', 'posted a message', time() - 100000000, ''));
                    $board->addActivity(new Activity('sfd', 'posted a message', time() - 1000000000, ''));
...
<script>document.title = document.title + ": <?php echo "test"; ?>";</script>
