            ...
            <div class="container-fluid z-0">
                ...
                <div class="content mb-5 mt-20">
                    <div class="btn-toolbar" role="toolbar">
                        <h2 class="font-size-20 p-0 m-0 mr-20 font-weight-bold">projects</h2>
                        <input type="text" class="form-control w-100 w-sm-200 disabled" placeholder="search"
                               readonly="readonly">
                ...
                <div class="row" id="gridView" style="display: flex">
                    <?php
                    for ($i = 0; $i < 10; $i++) {
                        echo getCard(2, '/project.php?id=', '/data/1234/art-1000-comp.jpg', 'project', '1d ago');
                    }
                    ?>
                ...
                <div class="card" id="listView" style="display: none">
                    <table class="table table-hover table-striped table-no-outer-padding">
                        ...
                        <tr>
                            <th class="col-1"></th>
                            <th class="col-7">project name</th>
                        ...
                        <?php
                        for ($i = 0; $i < 10; $i++) {
                            echo getListItem(2, '/project.php?id=', '/data/1234/art-100-comp.jpg', 'project', '1d ago', 'dan');
                        }
                        ?>
                        </tbody>
                    </table>
